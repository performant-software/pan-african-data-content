...
The [Organizations Explorer](https://www.panafricandata.org/en/search/organizations/) includes 53 organizations that we have been able to verify as having existed, for which we have found at least one participant. These are certainly not all the organizations that contributed to Pan-Africanism. The diverse types of groups in the dataset include student organizations, journals and periodicals, and other activist groups. In the future, we hope to have identified enough organizations that disaggregating them into specific categories through faceted search would make sense.
