...
sections:
  ...
  - body: >
      ...
      * IP address (used for security and analytics only). 
      ...
      Individuals who wish to contribute content — such as paths, posts, or
      datasets — may request a user account. Account requests are reviewed and
      ...
      living individuals.
       All research materials are derived from publicly available archival or scholarly sources and are presented for educational and research purposes only.
      ...
      request a review of the relevant material. The project team will evaluate
      all such requests in good faith, prioritizing considerations of privacy,
      dignity, and historical integrity.
      ...
      ### 3. Cookies and Accessibility Preferences
      ...
      * Remember user-selected accessibility preferences (e.g., contrast, text
      size) 
