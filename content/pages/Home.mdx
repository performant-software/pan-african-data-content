...
sections:
  ...
  - size: small
    _template: spacer
  - body: >
      \<span style="background-color\:black"> **Site status:** The Events and
      Organization Explorers are running smoothly. Data in the People Explorer
      may load slowly or incompletely due to the size of the dataset, but you
      can still search for individuals by name. We appreciate your patience as
      we continue improving performance —an update to enhance loading speed is
      scheduled for the week of November 3, 2025.\</span>
    _template: free_text
  ...
  - title: About the Project
    description: >-
      ...
      Pan-Africanism from 1900 to 1960. Through data curation and visualization,
      the project highlights the global networks of Black liberation and
      solidarity that link Africa and its diasporas. Drawing on archival and
      scholarly sources, it offers searchable, interactive views — maps, tables,
      and timelines — that reveal the scope and connections of Pan-African
