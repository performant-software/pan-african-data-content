...
sections:
  ...
  - items:
    ...
    _template: carousel
  - body: >
      **Site status:** The Events and Organization Explorers are running
      smoothly. Data in the People Explorer may load slowly or incompletely due
      to the size of the dataset, but users can still search for individuals by
      name but should expect delays in retrieving results. We appreciate
      patience as we continue improving performance — an update to enhance
      loading speed is scheduled for the week of November 3, 2025.
    _template: free_text
