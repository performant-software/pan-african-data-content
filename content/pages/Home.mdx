...
sections:
  ...
  - items:
      - title: Events
        description: >-
          Explore key events in Pan-Africanism since the early twentieth century
          through map, table, and timeline views
      ...
      - title: Organizations
        description: >-
          Discover Pan-African organizations active during the twentieth century
