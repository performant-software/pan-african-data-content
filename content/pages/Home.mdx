...
sections:
  ...
  - body: >
      **Site status:** The Events and Organization Explorers are running
      ...
      to the size of the dataset, but you can still search for individuals by
      name. We appreciate your patience as we continue improving performance —an
      update to enhance loading speed is scheduled for the week of November 3,
      2025.
    _template: free_text
