...
path:
  ...
  - place:
    ...
    blurb: >
      ...
      geography and time. To use Paths for research, please contact [Roopika
...
Paths trace stories that unfold across time and space. Using places drawn from the Explorers, creators can build interpretive narratives that show how people, movements, and ideas travel. This Path demonstrates how the functionality supports storytelling and can serve as a teaching and research tool.
