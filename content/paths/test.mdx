...
Paths offer an interactive way to trace stories that unfold across time and space. A Path can link places from the database and allows users to follow how movements, exchanges, and ideas travel. This Path demonstrates how the functionality can guide storytelling, illustrate transformation, and serve as a teaching and research tool.
