...
The Paths functionality offers an interactive way to trace stories that unfold across time and space. A Path can link events, organizations, people, and places, allowing users to follow how movements, exchanges, and ideas travel through geography and history. As users progress along a path, the map and text move in tandem, revealing how narrative, space, and sequence work together. This Path demonstrates how the tool can guide storytelling, illustrate transformation, and serve as a teaching and research tool.
