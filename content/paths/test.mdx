...
path:
  - place:
    ...
    blurb: >
      ...
      naturally to the next within a spatial narrative. Images and audio-visual
      assets can be incorporated in path pages as well. 


      ![](https://core-data-tina-cms.s3.us-east-1.amazonaws.com/pan-african-data-content/Algerian_war_collage.jpg
      "Algerian War Collage. Public domain, via Wikimedia Commons")
  - place:
      title: Afghanistan
